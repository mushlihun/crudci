        ...
        <div class="row contact-wrap">
            ...
            <div class="col-md-6 col-md-offset-3">
                <form method="post" role="form">
                    <input type="hidden" class="form-control" name="nik_old" id="nik_old" required value="<?= $data->nik ?>">
                    <div class="form-group">
                        <input type="number" class="form-control" name="nik" id="nik" minlength="1" placeholder="NIK" value="<?= $data->nik ?>" onblur="checkAvailability()" required>
                        <span id="user-availability-status"></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_kps" id="nama_kps" placeholder="Nama" minlength="1" value="<?= $data->nama_kps ?>" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="username" id="username" placeholder="Nama Pengguna" value="<?= $data->username ?>" required>
                    </div>
                    <div class="form-group">
